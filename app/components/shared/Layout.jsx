...
const PageWrapper = props => (
  <PageWrapperStyle subnav={props.subnav}>{props.children}</PageWrapperStyle>
);

const PageHeader = props => <PageHeaderStyle subnav={props.subnav} >{props.children}</PageHeaderStyle>;
...
const PageContent = props => (
  <PageContentStyle bare={props.bare} subnav={props.subnav}>{props.children}</PageContentStyle>
);
